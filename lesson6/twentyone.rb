...
player_cards = [] 
dealer_cards = []
deck = [["2/Hearts", 2], ["3/Hearts", 3], ["4/Hearts", 4], ["5/Hearts", 5], ["6/Hearts", 6], ["7/Hearts", 7], ["8/Hearts", 8], ["9/Hearts", 9], 
        ["10/Hearts", 10], ["Jack/Hearts", 10], ["Queen/Hearts", 10], ["King/Hearts", 10], ["Ace/Hearts", 11], 
        ...
        ["10/Clubs", 10], ["Jack/Clubs", 10], ["Queen/Clubs", 10], ["King/Clubs", 10], ["Ace/Clubs", 11], 
        ["2/Spades", 2], ["3/Spades", 3], ["4/Spades", 4], ["5/Spades", 5], ["6/Spades", 6], ["7/Spades", 7], ["8/Spades", 8], ["9/Spades", 9], 
        ["10/Spades", 10], ["Jack/Spades", 10], ["Queen/Spades", 10], ["King/Spades", 10], ["Ace//Spades", 11]]
...
def winner_is?(player_cards, dealer_cards) 
  if busted?(player_cards) || busted?(dealer_cards)
    nil
  elsif (card_value(player_cards) > card_value(dealer_cards)) && !busted?(player_cards)
    puts "Player won!"
  elsif (card_value(player_cards) < card_value(dealer_cards)) && !busted?(dealer_cards)
    puts "Dealer won!"
  else 
    puts "It's a tie!"
  end 
